...
const UserDetailsCard = ({userDetails}) => {
    const { name, email, username, phone, website, address, company } = userDetails;
  ...
  return (
    <div>
         <div className='border rounded-md'>
                  ...
                  <span className='custom-span'>{address?.suite}, {address?.street}
                  {address?.city}, {address?.zipcode}</span>
                  </div>
                  </section>
                  ...
                  <div className=' flex items-start gap-2 '>
                      <Briefcase className="text-yellow-500 h-4 w-4 mt-0.5" />
                              ...
                              <div className='custom_div_one'>
                  <span className='custom-span text-gray-500'>{company?.catchPhrase}</span>
                  </div>
